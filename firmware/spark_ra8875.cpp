/*
Part of RA8875 library from https://github.com/sumotoy/spark_ra8875
...
//------------------------------TEENSY 3/3.1 ---------------------------------------
	...
	spark_ra8875::spark_ra8875(const uint8_t CSp,const uint8_t RSTp,const uint8_t mosi_pin,const uint8_t sclk_pin,const uint8_t miso_pin)
	{
		_mosi = mosi_pin;
		_miso = miso_pin;
		_sclk = sclk_pin;
...
//---------------------------------DUE--------------------------------------------
	...
	spark_ra8875::spark_ra8875(const uint8_t CSp, const uint8_t RSTp) 
	{
		_cs = CSp;
		_rst = RSTp;
//---------------------------------SPARK----------------------------------------
...
//------------------------------ENERGIA-------------------------------------------
	...
	spark_ra8875::spark_ra8875(const uint8_t module, const uint8_t RSTp) 
	{
		selectCS(module);
		_rst = RSTp;
		_cs = 255;
...
void spark_ra8875::selectCS(uint8_t module) 
{
...
*/
/**************************************************************************/
void spark_ra8875::begin(const enum RA8875sizes s,uint8_t colors) 
{
	_errorCode = 0;
	_displaySize = s;
	_rotation = 0;
...
*/
/**************************************************************************/
void spark_ra8875::_setSysClock(uint8_t pll1,uint8_t pll2,uint8_t pixclk)
{
...
*/
/**************************************************************************/
uint8_t spark_ra8875::errorCode(void) 
{
	return _errorCode;
}
...
*/
/**************************************************************************/
boolean spark_ra8875::_waitPoll(uint8_t regname, uint8_t waitflag) 
{
	uint8_t temp;
...
*/
/**************************************************************************/
void spark_ra8875::_waitBusy(uint8_t res) 
{
	uint8_t temp; 	
...
/**************************************************************************/
/*
void spark_ra8875::clearMemory(boolean full)
{
...
*/
/**************************************************************************/
void spark_ra8875::clearMemory(bool stop)
{
	uint8_t temp;
...
*/
/**************************************************************************/
void spark_ra8875::clearActiveWindow(bool full)
{
	uint8_t temp;
	temp = _readRegister(RA8875_MCLR);
...
*/
/**************************************************************************/
void spark_ra8875::clearWidthColor(bool bte)
{
	uint8_t temp;
	temp = _readRegister(RA8875_MCLR);
...
*/
/**************************************************************************/
void spark_ra8875::displayOn(boolean on) 
{
...
*/
/**************************************************************************/
void spark_ra8875::setActiveWindow(int16_t XL,int16_t XR ,int16_t YT ,int16_t YB)
{
...
*/
/**************************************************************************/
void spark_ra8875::setActiveWindow(void)
{
...
*/
/**************************************************************************/
void spark_ra8875::getActiveWindow(int16_t &XL,int16_t &XR ,int16_t &YT ,int16_t &YB)//0.69b24
{
...
*/
/**************************************************************************/
uint16_t spark_ra8875::width(bool absolute) const 
{ 
...
*/
/**************************************************************************/
uint16_t spark_ra8875::height(bool absolute) const 
{ 
...
*/
/**************************************************************************/
void spark_ra8875::_setTextMode(bool m) 
{
...
*/
/**************************************************************************/
void spark_ra8875::_scanDirection(boolean invertH,boolean invertV)
{
...
*/
/**************************************************************************/
void spark_ra8875::setRotation(uint8_t rotation)//0.69b32 - less code
{
...
*/
/**************************************************************************/
uint8_t spark_ra8875::getRotation()
{
	return _rotation;
}
...
*/
/**************************************************************************/
boolean spark_ra8875::isPortrait(void)
{
	return _portrait;
}
...
*/
/**************************************************************************/
void spark_ra8875::uploadUserChar(const uint8_t symbol[],uint8_t address) 
{
...
*/
/**************************************************************************/
void spark_ra8875::showUserChar(uint8_t symbolAddrs,uint8_t wide) 
{
...
*/
/**************************************************************************/
void spark_ra8875::setIntFontCoding(enum RA8875fontCoding f) 
{
...
*/
/**************************************************************************/
void spark_ra8875::setExternalFontRom(enum RA8875extRomType ert, enum RA8875extRomCoding erc, enum RA8875extRomFamily erf)
{
...
void spark_ra8875::fontRomSpeed(uint8_t sp)
{
...
void spark_ra8875::_setFNTdimensions(uint8_t index) 
{
...
*/
/**************************************************************************/
void spark_ra8875::setFont(const tFont *font) 
{
	_currentFont = font;
...
*/
/**************************************************************************/
void spark_ra8875::setFontFullAlign(boolean align) 
{
...
*/
/**************************************************************************/
void spark_ra8875::setFontInterline(uint8_t pix)
{
...
*/
/**************************************************************************/
void spark_ra8875::setCursor(int16_t x, int16_t y,bool autocenter) 
{
	if (x < 0) x = 0;
	if (y < 0) y = 0;
...
*/
/**************************************************************************/
void spark_ra8875::_textPosition(int16_t x, int16_t y,bool update)
{
...
*/
/**************************************************************************/
void spark_ra8875::getCursor(int16_t &x, int16_t &y) 
{
	if (bitRead(_TXTparameters,7) == 1) {
		getCursorFast(x,y);
	} else {
...
*/
/**************************************************************************/
void spark_ra8875::getCursorFast(int16_t &x, int16_t &y)
{
	x = _cursorX;
	y = _cursorY;
	if (_portrait) swapvals(x,y);
...
int16_t spark_ra8875::getCursorX(void)
{
	if (_portrait) return _cursorY;
	return _cursorX;
}

int16_t spark_ra8875::getCursorY(void)
{
...
*/
/**************************************************************************/
void spark_ra8875::showCursor(enum RA8875tcursor c,bool blink)
{
...
*/
/**************************************************************************/
void spark_ra8875::setCursorBlinkRate(uint8_t rate)
{
...
*/
/**************************************************************************/
void spark_ra8875::setTextColor(uint16_t fcolor, uint16_t bcolor)//0.69b30
{
	#if defined(USE_RA8875_SEPARATE_TEXT_COLOR)
...
void spark_ra8875::setTextColor(uint16_t fcolor)
{
	#if defined(USE_RA8875_SEPARATE_TEXT_COLOR)
		if (fcolor != _TXTForeColor) {
			_TXTForeColor = fcolor;
...
void spark_ra8875::setTextGrandient(uint16_t fcolor1,uint16_t fcolor2)
{
	_FNTgrandient = true;
...
*/
/**************************************************************************/
void spark_ra8875::setFontScale(uint8_t scale)
{
...
*/
/**************************************************************************/
void spark_ra8875::setFontScale(uint8_t xscale,uint8_t yscale)
{
	_scaling = false;
	if (bitRead(_TXTparameters,7) == 0){
...
*/
/**************************************************************************/
void spark_ra8875::cursorIncrement(bool on)
{
	if (bitRead(_TXTparameters,7) == 0){
...
*/
/**************************************************************************/
uint8_t spark_ra8875::getFontWidth(boolean inColums) 
{
	uint8_t temp;
	if (bitRead(_TXTparameters,7) == 1){
		temp = _FNTwidth;
...
*/		
/**************************************************************************/
uint8_t spark_ra8875::getFontHeight(boolean inRows) 
{
	uint8_t temp;
	if (bitRead(_TXTparameters,7) == 1){
		temp = _FNTheight;
...
*/
/**************************************************************************/
void spark_ra8875::setFontSpacing(uint8_t spc)
{
...
void spark_ra8875::_textWrite(const char* buffer, uint16_t len)
 {
	uint16_t i;
...
*/
/**************************************************************************/
void spark_ra8875::_charWriteR(const char c,uint8_t offset,uint16_t fcolor,uint16_t bcolor)
{
	if (c == 13){//------------------------------- CARRIAGE ----------------------------------
		//ignore
...
*/
/**************************************************************************/
void spark_ra8875::_charWrite(const char c,uint8_t offset)
{
	bool dtacmd = false;
	if (c == 13){//'\r'
...
*/
/**************************************************************************/
int spark_ra8875::_getCharCode(uint8_t ch)
{
	int i;
...
*/
/**************************************************************************/
int16_t spark_ra8875::_STRlen_helper(const char* buffer,uint16_t len)
{
...
*/
/**************************************************************************/
void spark_ra8875::_drawChar_unc(int16_t x,int16_t y,int charW,int index,uint16_t fcolor)
{
...
*/
/**************************************************************************/
void spark_ra8875::_charLineRender(bool lineBuffer[],int charW,int16_t x,int16_t y,int16_t currentYposition,uint16_t fcolor)
{
	int xlinePos = 0;
	int px;
	uint8_t endPix = 0;
...
*/
/**************************************************************************/	
void spark_ra8875::_drawChar_unc(int16_t x,int16_t y,int16_t w,const uint8_t *data,uint16_t fcolor,uint16_t bcolor)
{
...
/*
void spark_ra8875::_drawChar_com(int16_t x,int16_t y,int16_t w,const uint8_t *data)
{
}
*/
...
*/
/**************************************************************************/
void spark_ra8875::setColorBpp(uint8_t colors)
{
...
*/
/**************************************************************************/
uint8_t spark_ra8875::getColorBpp(void)
{
	return _color_bpp;
}
...
*/
/**************************************************************************/
void spark_ra8875::setForegroundColor(uint16_t color)
{
...
*/
/**************************************************************************/
void spark_ra8875::setForegroundColor(uint8_t R,uint8_t G,uint8_t B)
{
...
*/
/**************************************************************************/
void spark_ra8875::setBackgroundColor(uint16_t color)
{
...
*/
/**************************************************************************/
void spark_ra8875::setBackgroundColor(uint8_t R,uint8_t G,uint8_t B)
{
...
*/
/**************************************************************************/
void spark_ra8875::setTransparentColor(uint16_t color)
{
	_backColor = color;
...
*/
/**************************************************************************/
void spark_ra8875::setTransparentColor(uint8_t R,uint8_t G,uint8_t B)
{
	_backColor = Color565(R,G,B);//keep track
...
*/
/**************************************************************************/
void spark_ra8875::setColor(uint16_t fcolor,uint16_t bcolor,bool bcolorTraspFlag)//0.69b30
{
	if (fcolor != _foreColor) setForegroundColor(fcolor);
	if (bcolorTraspFlag){
...
*/
/**************************************************************************/
void spark_ra8875::setGraphicCursor(uint8_t cur) 
{
	if (cur > 7) cur = 7;
...
*/
/**************************************************************************/
void spark_ra8875::showGraphicCursor(boolean cur) 
{
	uint8_t temp = _readRegister(RA8875_MWCR1);
...
void spark_ra8875::setXY(int16_t x, int16_t y) 
{
	setX(x);
	setY(y);
}
...
*/
/**************************************************************************/
void spark_ra8875::setX(int16_t x) 
{
	if (x < 0) x = 0;
...
*/
/**************************************************************************/
void spark_ra8875::setY(int16_t y) 
{
	if (y < 0) y = 0;
	if (_portrait){//fix 0.69b21
...
*/
/**************************************************************************/
void spark_ra8875::setScrollMode(enum RA8875scrollMode mode)
{
...
*/
/**************************************************************************/
void spark_ra8875::setScrollWindow(int16_t XL,int16_t XR ,int16_t YT ,int16_t YB)
{
...
*/
/**************************************************************************/
void spark_ra8875::scroll(int16_t x,int16_t y)
{ 
	if (_portrait) swapvals(x,y);
...
*/
/**************************************************************************/
void spark_ra8875::DMA_blockModeSize(int16_t BWR,int16_t BHR,int16_t SPWR)
{
...
*/
/**************************************************************************/
void spark_ra8875::DMA_startAddress(unsigned long adrs)
{ 
...
*/
/**************************************************************************/
void spark_ra8875::DMA_enable(void)
{ 
...
*/
/**************************************************************************/
void spark_ra8875::drawFlashImage(int16_t x,int16_t y,int16_t w,int16_t h,uint8_t picnum)
{  
...
void  spark_ra8875::BTE_move(int16_t SourceX, int16_t SourceY, int16_t Width, int16_t Height, int16_t DestX, int16_t DestY, uint8_t SourceLayer, uint8_t DestLayer,bool Transparent, uint8_t ROP, bool Monochrome, bool ReverseDir)
{
...
*/
/**************************************************************************/
void spark_ra8875::BTE_size(int16_t w, int16_t h)
{
...
void spark_ra8875::BTE_moveFrom(int16_t SX,int16_t SY)
{
...
void spark_ra8875::BTE_moveTo(int16_t DX,int16_t DY)
{
...
*/
/**************************************************************************/
void spark_ra8875::BTE_ropcode(unsigned char setx)
{
...
*/
/**************************************************************************/
void spark_ra8875::BTE_enable(bool on) 
{	
...
*/
/**************************************************************************/
void spark_ra8875::BTE_dataMode(enum RA8875btedatam m) 
{	
	uint8_t temp = _readRegister(RA8875_BECR0);
...
void spark_ra8875::BTE_layer(enum RA8875btelayer sd,uint8_t l)
{
	uint8_t temp;
...
/**************************************************************************/
/*!
		Instruct the spark_ra8875 chip to use 2 layers
...
*/
/**************************************************************************/
void spark_ra8875::useLayers(boolean on) 
{
...
*/
/**************************************************************************/
void spark_ra8875::layerEffect(enum RA8875boolean efx)
{
...
*/
/**************************************************************************/
void spark_ra8875::layerTransparency(uint8_t layer1,uint8_t layer2)
{
...
*/
/**************************************************************************/
uint8_t spark_ra8875::getCurrentLayer(void)
{
...
*/
/**************************************************************************/
void spark_ra8875::setPattern(uint8_t num, enum RA8875pattern p)
{
	uint8_t maxLoc;
	uint8_t temp = 0b00000000;
	if (p != P16X16) {
...
*/
/**************************************************************************/
void spark_ra8875::writePattern(int16_t x,int16_t y,const uint8_t *data,uint8_t size,bool setAW)
{
	int16_t i;
	int16_t a,b,c,d;
...
*/
/**************************************************************************/
void spark_ra8875::writeTo(enum RA8875writes d)
{
	uint8_t temp = _readRegister(RA8875_MWCR1);
...
*/
/**************************************************************************/
/* void spark_ra8875::fillRect(void) {
...
*/
/**************************************************************************/
void spark_ra8875::drawPixel(int16_t x, int16_t y, uint16_t color)
{
	//setXY(x,y);
	if (_textMode) _setTextMode(false);//we are in text mode?
	setXY(x,y);
...
*/
/**************************************************************************/
void spark_ra8875::drawPixels(uint16_t p[], uint16_t count, int16_t x, int16_t y)
{
    //setXY(x,y);
	uint16_t temp = 0;
	uint16_t i;
...
*/
/**************************************************************************/
uint16_t spark_ra8875::getPixel(int16_t x, int16_t y)
{
    uint16_t color;
    setXY(x,y);
	if (_textMode) _setTextMode(false);//we are in text mode?
...
/*
void spark_ra8875::getPixels(uint16_t * p, uint32_t count, int16_t x, int16_t y)
{
    uint16_t color; 
    if (_textMode) _setTextMode(false);//we are in text mode?
    setXY(x,y);
...
*/
/**************************************************************************/
void spark_ra8875::drawLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1, uint16_t color)
{
...
*/
/**************************************************************************/
void spark_ra8875::drawLineAngle(int16_t x, int16_t y, int16_t angle, uint16_t length, uint16_t color,int offset)
{
...
*/
/**************************************************************************/
void spark_ra8875::drawLineAngle(int16_t x, int16_t y, int16_t angle, uint16_t start, uint16_t length, uint16_t color,int offset)
{
...
void spark_ra8875::roundGaugeTicker(uint16_t x, uint16_t y, uint16_t r, int from, int to, float dev,uint16_t color) 
{
  float dsec;
  int i;
...
*/
/**************************************************************************/
void spark_ra8875::drawFastVLine(int16_t x, int16_t y, int16_t h, uint16_t color)
{
	if (h < 1) h = 1;
...
*/
/**************************************************************************/
void spark_ra8875::drawFastHLine(int16_t x, int16_t y, int16_t w, uint16_t color)
{
	if (w < 1) w = 1;
...
*/
/**************************************************************************/
void spark_ra8875::drawRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color)
{
...
*/
/**************************************************************************/
void spark_ra8875::fillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color)
{
	//RA8875 it's not out-of-range tolerant so this is a workaround
	if (w < 1 || h < 1) return;//it cannot be!
	if (w < 2 && h < 2){ //render as pixel
...
*/
/**************************************************************************/
uint16_t spark_ra8875::grandient(uint8_t val)
{
	uint8_t r = 0;
	uint8_t g = 0;
	uint8_t b = 0;
...
*/
/**************************************************************************/
uint16_t spark_ra8875::colorInterpolation(uint16_t color1,uint16_t color2,uint16_t pos,uint16_t div)
{
...
*/
/**************************************************************************/
uint16_t spark_ra8875::colorInterpolation(uint8_t r1,uint8_t g1,uint8_t b1,uint8_t r2,uint8_t g2,uint8_t b2,uint16_t pos,uint16_t div)
{
...
*/
/**************************************************************************/
void spark_ra8875::drawMesh(int16_t x, int16_t y, int16_t w, int16_t h, uint8_t spacing, uint16_t color)
{
...
*/
/**************************************************************************/
void spark_ra8875::fillWindow(uint16_t color)
{  
...
*/
/**************************************************************************/
void spark_ra8875::clearScreen(uint16_t color)//0.69b24
{  
	setActiveWindow();
	fillWindow(color);
}
...
*/
/**************************************************************************/
void spark_ra8875::drawCircle(int16_t x0, int16_t y0, int16_t r, uint16_t color)
{
...
*/
/**************************************************************************/
void spark_ra8875::drawQuad(int16_t x0, int16_t y0,int16_t x1, int16_t y1,int16_t x2, int16_t y2,int16_t x3, int16_t y3, uint16_t color) 
{
...
*/
/**************************************************************************/
void spark_ra8875::fillQuad(int16_t x0, int16_t y0,int16_t x1, int16_t y1,int16_t x2, int16_t y2, int16_t x3, int16_t y3, uint16_t color, bool triangled) 
{
...
*/
/**************************************************************************/
void spark_ra8875::drawPolygon(int16_t cx, int16_t cy, uint8_t sides, int16_t diameter, float rot, uint16_t color)
{ 
...
*/
/**************************************************************************/
void spark_ra8875::ringMeter(int val, int minV, int maxV, int16_t x, int16_t y, uint16_t r, const char* units, uint16_t colorScheme,uint16_t backSegColor,int16_t angle,uint8_t inc)
{
	if (inc < 5) inc = 5;
	if (inc > 20) inc = 20;
	if (r < 50) r = 50;
...
*/
/**************************************************************************/
void spark_ra8875::drawTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint16_t color)
{
...
*/
/**************************************************************************/
void spark_ra8875::fillTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint16_t color)
{
	_triangle_helper(x0, y0, x1, y1, x2, y2, color, true);
}
...
*/
/**************************************************************************/
void spark_ra8875::drawEllipse(int16_t xCenter, int16_t yCenter, int16_t longAxis, int16_t shortAxis, uint16_t color)
{
...
*/
/**************************************************************************/
void spark_ra8875::fillEllipse(int16_t xCenter, int16_t yCenter, int16_t longAxis, int16_t shortAxis, uint16_t color)
{
...
*/
/**************************************************************************/
void spark_ra8875::drawCurve(int16_t xCenter, int16_t yCenter, int16_t longAxis, int16_t shortAxis, uint8_t curvePart, uint16_t color)
{
...
*/
/**************************************************************************/
void spark_ra8875::fillCurve(int16_t xCenter, int16_t yCenter, int16_t longAxis, int16_t shortAxis, uint8_t curvePart, uint16_t color)
{
	curvePart = curvePart % 4; //limit to the range 0-3
	if (_portrait) {//fix a problem with rotation
		if (curvePart == 0) {
...
*/
/**************************************************************************/
void spark_ra8875::drawRoundRect(int16_t x, int16_t y, int16_t w, int16_t h, int16_t r, uint16_t color)
{
...
*/
/**************************************************************************/
void spark_ra8875::fillRoundRect(int16_t x, int16_t y, int16_t w, int16_t h, int16_t r, uint16_t color)
{
...
*/
/**************************************************************************/
void spark_ra8875::_circle_helper(int16_t x0, int16_t y0, int16_t r, uint16_t color, bool filled)//0.69b32 fixed an undocumented hardware limit
{
...
*/
/**************************************************************************/
void spark_ra8875::_triangle_helper(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint16_t color, bool filled)
{
...
*/
/**************************************************************************/
void spark_ra8875::_ellipseCurve_helper(int16_t xCenter, int16_t yCenter, int16_t longAxis, int16_t shortAxis, uint8_t curvePart,uint16_t color, bool filled)
{
...
*/
/**************************************************************************/
void spark_ra8875::_roundRect_helper(int16_t x, int16_t y, int16_t w, int16_t h, int16_t r, uint16_t color, bool filled)
{
	if (_portrait) {swapvals(x,y); swapvals(w,h);}
...
*/
/**************************************************************************/
void spark_ra8875::_drawArc_helper(uint16_t cx, uint16_t cy, uint16_t radius, uint16_t thickness, float start, float end, uint16_t color) {
...
*/
/**************************************************************************/
void spark_ra8875::_updateActiveWindow(bool full)
{
	if (full){
		// X
...
*/
/**************************************************************************/
void spark_ra8875::_line_addressing(int16_t x0, int16_t y0, int16_t x1, int16_t y1)
{
	//X0
...
*/
/**************************************************************************/
void spark_ra8875::_curve_addressing(int16_t x0, int16_t y0, int16_t x1, int16_t y1)
{
	//center
...
*/
/**************************************************************************/
float spark_ra8875::_cosDeg_helper(float angle)
{
	float radians = angle / (float)360 * 2 * PI;
	return cos(radians);
}

float spark_ra8875::_sinDeg_helper(float angle)
{
	float radians = angle / (float)360 * 2 * PI;
	return sin(radians);
}
...
*/
/**************************************************************************/
void spark_ra8875::setArcParams(float arcAngleMax, int arcAngleOffset)
{
...
*/
/**************************************************************************/
void spark_ra8875::setAngleOffset(int16_t angleOffset)
{
...
*/
/**************************************************************************/
void spark_ra8875::GPIOX(boolean on) 
{
...
*/
/**************************************************************************/
void spark_ra8875::PWMout(uint8_t pw,uint8_t p)
{
	uint8_t reg;
...
*/
/**************************************************************************/
void spark_ra8875::brightness(uint8_t val) 
{
	_brightness = val;
...
*/
/**************************************************************************/
void spark_ra8875::backlight(boolean on) //0.69b31 (fixed an issue with adafruit backlight)
{
...
*/
/**************************************************************************/
void spark_ra8875::PWMsetup(uint8_t pw,boolean on, uint8_t clock) 
{
	uint8_t reg;
	uint8_t set;
	if (pw > 1){
...
void spark_ra8875::setInternalInt(enum RA8875intlist b)
{
	_enabledInterrups |= (1 << b);//set
}

void spark_ra8875::clearInternalInt(enum RA8875intlist b)
{
...
void spark_ra8875::useINT(const uint8_t INTpin,const uint8_t INTnum) 
{
	_intPin = INTpin;
	_intNum = INTnum;
...
*/
/**************************************************************************/
void spark_ra8875::enableISR(bool force) 
{
...
*/
/**************************************************************************/
void spark_ra8875::_disableISR(void) 
{
	if (_useISR){
		#if defined(USE_RA8875_TOUCH)
			if (_touchEnabled) _checkInterrupt(2);//clear internal RA int to engage
...
*/
/**************************************************************************/
bool spark_ra8875::_checkInterrupt(uint8_t _bit,bool _clear) 
{
	if (_bit > 4) _bit = 4;
...
*/
/**************************************************************************/
void spark_ra8875::useCapINT(const uint8_t INTpin,const uint8_t INTnum) 
{
	_intCTSPin = INTpin;
	_intCTSNum = INTnum;
	#if defined(___TEENSYES)//all of them (32 bit only)
...
*/
/**************************************************************************/
void spark_ra8875::cts_isr(void)
{
	_FT5206_INT = true;
}
...
*/
/**************************************************************************/
void spark_ra8875::enableCapISR(bool force) 
{
...
*/
/**************************************************************************/
void spark_ra8875::_disableCapISR(void) 
{
	if (_useISR){
		#ifdef digitalPinToInterrupt
...
*/
/**************************************************************************/
bool spark_ra8875::touched(bool safe)
{
...
void spark_ra8875::setTouchLimit(uint8_t limit)
{
	#if defined(USE_FT5206_TOUCH)
...
uint8_t spark_ra8875::getTouchLimit(void)
{
	return _maxTouch;
}
/*
...
*/
/**************************************************************************/
void spark_ra8875::_initializeFT5206(void)
{
	uint8_t i;
	for (i=0x80;i<=0x89;i++){
...
*/
/**************************************************************************/
void spark_ra8875::_sendRegFT5206(uint8_t reg,const uint8_t val)
{
    // save I2C bitrate
	#if !defined(___DUESTUFF)
...
*/
/**************************************************************************/
void spark_ra8875::updateTS(void)
{
...
*/
/**************************************************************************/
uint8_t spark_ra8875::getTScoordinates(uint16_t (*touch_coordinates)[2])
{
	uint8_t i;
...
*/
/**************************************************************************/
uint8_t spark_ra8875::getTouchState(void)
{
...
*/
/**************************************************************************/
uint8_t spark_ra8875::getTouches(void)
{
	return _currentTouches;
}
...
*/
/**************************************************************************/
uint8_t spark_ra8875::getGesture(void)
{
	return _gesture;
}
...
/*!   
	  ...
	  You need to use enableISR() [after] to enable ISR on MCU and spark_ra8875!
*/
/**************************************************************************/
void spark_ra8875::touchBegin(void) 
{
	if (_intPin < 255){
...
/*! 
	  ...
	  You must use touchBegin at list once to instruct the spark_ra8875
	  Parameters:
	  enabled: true(enable),false(disable)
*/
/**************************************************************************/
void spark_ra8875::touchEnable(boolean enabled) {
	if (_intPin < 255){
...
*/
/**************************************************************************/
void spark_ra8875::readTouchADC(uint16_t *x, uint16_t *y) 
{
	#if defined(_FASTCPU)
		_slowDownSPI(true);
	#endif
...
*/
/**************************************************************************/
void spark_ra8875::touchReadAdc(uint16_t *x, uint16_t *y) 
{
	uint16_t tx,ty;
	readTouchADC(&tx,&ty);
...
*/
/**************************************************************************/
void spark_ra8875::touchReadPixel(uint16_t *x, uint16_t *y) 
{
	uint16_t tx,ty;
	readTouchADC(&tx,&ty);
...
boolean spark_ra8875::touchCalibrated(void) 
{
	return _calibrated;
}
...
*/
/**************************************************************************/
boolean spark_ra8875::_isCalibrated(void) 
{
...
*/
/**************************************************************************/
void spark_ra8875::sleep(boolean sleep) 
{
...
*/
/**************************************************************************/
void spark_ra8875::_writeRegister(const uint8_t reg, uint8_t val) 
{
	writeCommand(reg);
	_writeData(val);
}
...
*/
/**************************************************************************/
uint8_t spark_ra8875::_readRegister(const uint8_t reg) 
{
	writeCommand(reg);
...
*/
/**************************************************************************/
void spark_ra8875::_writeData(uint8_t data) 
{
	_startSend();
	#if defined(___DUESTUFF) && defined(SPI_DUE_MODE_EXTENDED)
...
*/
/**************************************************************************/
void  spark_ra8875::writeData16(uint16_t data) 
{
	_startSend();
	#if (defined(__AVR__) && defined(_FASTSSPORT)) || defined(SPARK)
		_spiwrite(RA8875_DATAWRITE);
...
*/
/**************************************************************************/
uint8_t spark_ra8875::_readData(bool stat) 
{
	#if defined(SPI_HAS_TRANSACTION)
...
*/
/**************************************************************************/
uint8_t	spark_ra8875::readStatus(void) 
{
...
*/
/**************************************************************************/
void spark_ra8875::writeCommand(const uint8_t d) 
{
	_startSend();
	#if defined(___DUESTUFF) && defined(SPI_DUE_MODE_EXTENDED)
...
/*
 void spark_ra8875::debugData(uint16_t data,uint8_t len)
{
	int i;
	for (i=len-1; i>=0; i--){
		if (bitRead(data,i)==1){
...
/*
 void spark_ra8875::showLineBuffer(uint8_t data[],int len)
{
	int i;
	for (i=0; i<len; i++){
		if (data[i] == 1){
